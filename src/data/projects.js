...
const projects = [
  {
    ...
    summary:
      'A clean, modern site for a Columbus dental practice, with generous white space, a calm tone, and online booking that highlights both office visits and mobile "dentistry at your doorstep" care.',
    desc:
      'Aura Dental in Columbus, GA wanted their site to feel like "a steady pause in the middle of a busy day." The design leans into that with airy layouts, soft imagery, and reassuring copy that positions the practice as calm and approachable. It surfaces their signature offering, a fully equipped mobile dentistry van bringing care to patients’ doorsteps, alongside routine and restorative services, with online booking and phone scheduling built into the flow. Built on WordPress.',
  ...
  },
  {
    ...
    tags: ['WordPress', 'Web Design', 'Responsive'],
    summary:
      'A serene, editorial marketing site for a Minnesota orthodontic practice, with warm photography, clear treatment guidance, and quick booking and directions.',
    desc:
      'Victoria Orthodontics, led by Dr. Allen in Victoria, Minnesota, wanted a site that felt calm and welcoming rather than clinical. The design uses soft, serene imagery and an unhurried layout to convey the practice’s values of honesty, respect, and kindness. Doctor and services pages explain personalized treatment planning informed by surgical training, while prominent call buttons, business hours, and Google Maps integration make it effortless for prospective patients to take the next step. Built on WordPress.',
